...
public class ProjectHandlerXML extends DefaultHandler{
	 ...
	 private ResearchControler rsControler;
     ...
     public ProjectHandlerXML(ResearchControler rsCntrl) {
		super();
    	 ...
    	 if (localName.equals("value")) {
       	  ...
       	  if(isDefined){ 
       		  ...
       		  if (!attCreated) {
       			  	...
       			  	attId=rsControler.addProjectField(rsControler.getIdRs(),name, label,desc,predValue,"complex",category);
       			           			  	
       			  	attCreated=true;
       			  	
       			  
       			  	rsControler.addFieldItem(attId, tempVal);
    		  ...
    		  if (!attCreated && !isDefined)  {
    			  ...
    			  if(name.equals("photo")){
        			  ...
        			  attId=rsControler.addProjectField(rsControler.getIdRs(),name, label,desc,predValue,"photo",category);

    			  }
    			  else if(name.equals("ObservationAuthor")){
    				  
        			  attId=rsControler.addProjectNotEditableField(rsControler.getIdRs(),name, label,desc,"","simple",category);
        			  ...
        			  attId=rsControler.addProjectField(rsControler.getIdRs(),name, label,desc,predValue,"simple",category);
        	  ...
        	  rsControler.setCitationType(tempVal);
