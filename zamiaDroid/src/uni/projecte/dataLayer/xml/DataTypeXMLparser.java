...
public class DataTypeXMLparser {
	...
	public DataTypeXMLparser(DataTypeControler dt){
	...
	try {
         ...
         DataTypesHandlerXML myExampleHandler = new DataTypesHandlerXML(dtH);
         ...
         if (internet){
       		...
       		URL urlR = new URL(url); 
       		 ...
       		 xr.parse(new InputSource(urlR.openStream())); 
       	  	  ...
       	  	  InputStream fis = c.getAssets().open("datatypes.xml");
